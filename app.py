...
if st.session_state.tela == "entrada":
    ...
    with col_dados:
        ...
        if c_novo_btn.button("Criar Campo", use_container_width=True):
            ...
            if nome_limpo and nome_limpo not in st.session_state.campos_extras:
                # Cria o campo novo ativo por padrão
                st.session_state.campos_extras[nome_limpo] = {"ativo": True}
                # Insere ele na lista de ordem de impressão
    ...
    with col_controle:
        ...
        # Junta todos os dados para estruturar o texto do selo impresso
        dados_etiqueta = {
        ...
        # Calcula tamanho de fonte dinâmico para o título não quebrar a etiqueta
        ...
        # Adiciona na etiqueta apenas o que está ativo seguindo a ordem configurada
        for tag in st.session_state.ordem_linhas:
            if tag in dados_etiqueta:
                # Se for Classificação ou um dos campos extras criados pelo usuário, ganha destaque em negrito
        ...
        # Desenha o quadrado físico simulando o adesivo
        st.markdown(f"""
        ...
        # Checkboxes automáticos para os campos extras que você for criando
    ...
    # ------------------------------------------------------
    # BASE DA TELA: BOTÕES DE SALVAMENTO E COMPACTAÇÃO DE FILA
    # ------------------------------------------------------
    st.markdown("---")
...
# ==========================================================
# TELA DE CALIBRAGEM (Se mantem isolada e limpa)
# ==========================================================
    ...
    if not st.session_state.livros:
        ...
        for l in st.session_state.livros:
            ...
            """
        html_estante += "</div>"
        st.markdown(html_estante, unsafe_allow_html=True)import streamlit as st
import pandas as pd
